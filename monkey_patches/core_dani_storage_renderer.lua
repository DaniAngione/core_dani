-- This monkey patch was originally made by PaultheGreat for ACE and is being used here with his permission
-- and the ACE team permission
...
local CoreDaniStorageRenderer = class()

local REPOSITION_FILL = 'fill'
local REPOSITION_SHIFT = 'shift'

function CoreDaniStorageRenderer:_move_item_renderer(from_bone, to_bone)
...
function CoreDaniStorageRenderer:_update()
...
function CoreDaniStorageRenderer:_render_item(item, bone)
...
return CoreDaniStorageRenderer
